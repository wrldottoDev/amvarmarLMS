...
export function ContenedorAuth({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <main className="grid min-h-screen bg-white lg:grid-cols-[minmax(340px,0.85fr)_1.15fr]">
      <section className="flex min-h-screen items-center justify-center px-6 py-10 sm:px-10 lg:min-h-0">
        <div className="w-full max-w-sm">
          <div className="mb-10 flex items-center gap-3">
            <span className="grid size-11 place-items-center rounded-md bg-[#fff0e9]">
      ...
      <aside className="relative hidden overflow-hidden bg-[var(--mar-oscuro)] lg:block" aria-hidden="true">
        ...
        <div className="absolute inset-0 grid place-items-center p-16">
          <div className="relative h-[420px] w-full max-w-xl border-y border-white/15">
            ...
            <div className="absolute left-[16%] top-14 size-3 rounded-full bg-[#f3a51f]" />
            <div className="absolute left-[16%] top-[62px] h-[120px] w-px bg-[#f3a51f]" />
            <div className="absolute left-[16%] top-[174px] h-px w-[46%] bg-[#f3a51f]" />
            <div className="absolute left-[62%] top-[169px] size-3 rounded-full bg-[#f3a51f]" />
            <div className="absolute left-[62%] top-[181px] h-[142px] w-px bg-[#f3a51f]" />
            <div className="absolute bottom-[91px] left-[62%] h-px w-[25%] bg-[#f3a51f]" />
